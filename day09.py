...
with open('./inputs/day09') as inpt:
    parsed = list(map(lambda x: int(x), inpt.readline().split(',')))
    t_seq = [109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99]
    t_seq2 = [1102,34915192,34915192,7,4,7,99,0]
    t_seq3 = [104,1125899906842624,99]
    # part one
    c = Computer(parsed)
    c.calculate()
    print(c.last_output)
